module github.com/pulumi/pulumi-cloudflare/provider/v6
...
require (
	...
	github.com/cloudflare/cloudflare-go/v6 v6.0.1 // indirect
...
replace (
	github.com/webwarrior-ws/terraform-provider-cloudflare/shim => ./shim
